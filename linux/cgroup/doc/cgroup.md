...
* **pids** 限制一个cgroup及其子cgroup中的总进程数。
...
* 任何单一子系统（比如 `cpu`）最多可附加到一个层级中。
  ...
  ![RMG-rule1](D:\work_space\code\linux\cgroup\doc\res\RMG-rule1.png)

  

* 单一层级可附加一个或者多个子系统。

  ![RMG-rule2](D:\work_space\code\linux\cgroup\doc\res\RMG-rule2.png)
